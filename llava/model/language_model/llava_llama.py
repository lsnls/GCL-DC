...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        # image_feats: [B, 4096]
        input_ids, attention_mask, past_key_values, inputs_embeds, labels, image_feats = self.prepare_inputs_labels_for_multimodal(input_ids, attention_mask, past_key_values, labels, images)
